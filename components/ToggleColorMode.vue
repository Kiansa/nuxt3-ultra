  ...
  <Menu as="div" class="relative ml-4">
    <div>
      <MenuButton class="flex rounded-full bg-zinc-200 dark:bg-zinc-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 p-2">
        ...
        <SunIcon v-if="$colorMode.value === 'light'" class="h-7 w-7 text-zinc-700 dark:text-zinc-300" aria-hidden="true" />
        <MoonIcon v-if="$colorMode.value === 'dark'" class="h-7 w-7 text-zinc-700 dark:text-zinc-300" aria-hidden="true" />
      </MenuButton>
    </div>
